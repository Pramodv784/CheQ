...
public class CardExpiryUtils {
    ...
    private static final CardExpiryUtils INSTANCE = new CardExpiryUtils(Calendar.getInstance());
     ...
     */
    protected CardExpiryUtils(Calendar calendar) {
        mCalendar = calendar;
    }
...
//        }
    ...
    public static boolean checkMonthValidity(int month) {
